...
function atualizarTamanho() {
  ...
  numTamanhoSelecionada = opcaoTamanhoSelecionada;
  const tamanhocaixa = opcoesTamanho[numTamanhoSelecionada];
  const nomeCor = opcoesCores[numCorSelecionada];

   tituloProduto.innerText =
    "Pulseira loop esportiva " + nomeCor.toLowerCase() + " para caixa de " + tamanhocaixa;
  ...
  //   console.log(opcoesTamanho[numTamanhoSelecionada]);
  //   console.log(opcaoTamanhoSelecionada);
}
...
function atualizarCorSelecionada() {
  const opcaoCorSelecionada = document
    ...
    imagemVisualizacao.src =
    "./imagens/opcoes-cores/imagens-" + nomeCor.toLowerCase() + "/imagem-" + 
